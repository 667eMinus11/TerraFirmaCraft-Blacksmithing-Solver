...
target=65
hits={"hit 1":-3, "hit 2":-6,"hit 3":-9,"draw":-15,"key":2,"bend":7,"axe":13,"syth":16}
...
tree=[["hit 1"],["hit 2"],["hit 3"],["draw"],["key"],["bend"],["axe"],["syth"]]
_tree=tree
...
val1=Label(root, text='any action', bg='#F0F8FF', font=('ariel', 12, 'normal'),borderwidth=2,relief="groove",)


# This is the section of code which creates the a label
val2=Label(root, text='any action', bg='#F0F8FF', font=('ariel', 12, 'normal'),borderwidth=2,relief="groove",)


# This is the section of code which creates the a label
val3=Label(root, text='any action', bg='#F0F8FF', font=('ariel', 12, 'normal'),borderwidth=2,relief="groove",)
...
val1B=Button(root, text='Last', bg='#F0F8FF', font=('ariel', 12, 'normal'), command=SelectLast)
val1B.place(x=395, y=126)

# This is the section of code which creates a button
val2B=Button(root, text='2nd to Last', bg='#F0F8FF', font=('ariel', 12, 'normal'), command=Select2ndLast)
val2B.place(x=465, y=126)

# This is the section of code which creates a button
val3B=Button(root, text='3rd to Last', bg='#F0F8FF', font=('ariel', 12, 'normal'), command=Select3rdLast)
...
listBoxOne=Listbox(root, bg='#F0F8FF', font=('ariel', 12, 'normal'), width=0, height=0)
...
# This is the section of code which creates the a label
Label(root, text='Solution:', bg='#F0F8FF', font=('ariel', 12, 'normal')).place(x=195, y=266)
...
# This is the section of code which creates a button
Button(root, text='Solve', bg='#F0F8FF', font=('ariel', 15, 'bold'), command=solve).place(x=195, y=220)

listBoxOne.bind('<<ListboxSelect>>', selectedListbox)
# This is the section of code which creates the a label
Label(root, text='Target Value:', bg='#F0F8FF', font=('ariel', 12, 'bold')).place(x=150, y=126)

Label(root, text='Enter value needed (red arrow in anvil gui), then select one of the move restriction buttons, \nwhen it is highlighted select a move from the left. when done press solve ', bg='#F0F8FF', font=('ariel', 11, 'normal'),justify="left").place(x=10, y=10)

# This is the section of code which creates the a label
sol=Label(root, text='', bg='#F0F8FF', font=('ariel', 12, 'normal'),justify="left")
