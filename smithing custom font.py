...
target=65
hits={"hit 1 È":-3, "hit 2 É":-6,"hit 3 Ê":-9,"draw Ë":-15,"key Ì":2,"bend Í":7,"axe Î":13,"syth Ï":16}
_any=["hit 1 È","hit 2 É","hit 3 Ê","draw Ë","key Ì","bend Í","axe Î","syth Ï"]
_hit=["hit 1 È","hit 2 É","hit 3 Ê"]
##requirmentLast=_any
##requirmentSecondtoLast=_any
##requirmentThirdtoLast=_any
requirmentLast=["bend Í"]
requirmentSecondtoLast=["bend Í"]
requirmentThirdtoLast=["draw Ë"]
preCombo=[]
...
tree=[["hit 1 È"],["hit 2 É"],["hit 3 Ê"],["draw Ë"],["key Ì"],["bend Í"],["axe Î"],["syth Ï"]]
_tree=tree
...
val1=Label(root, text='any action', bg='#F0F8FF', font=('Custom', 12, 'normal'),borderwidth=2,relief="groove",)


# This is the section of code which creates the a label
val2=Label(root, text='any action', bg='#F0F8FF', font=('Custom', 12, 'normal'),borderwidth=2,relief="groove",)


# This is the section of code which creates the a label
val3=Label(root, text='any action', bg='#F0F8FF', font=('Custom', 12, 'normal'),borderwidth=2,relief="groove",)
...
val1B=Button(root, text='Last', bg='#F0F8FF', font=('Custom', 12, 'normal'), command=SelectLast)
val1B.place(x=395, y=126)

# This is the section of code which creates a button
val2B=Button(root, text='2nd to Last', bg='#F0F8FF', font=('Custom', 12, 'normal'), command=Select2ndLast)
val2B.place(x=465, y=126)

# This is the section of code which creates a button
val3B=Button(root, text='3rd to Last', bg='#F0F8FF', font=('Custom', 12, 'normal'), command=Select3rdLast)
...
listBoxOne=Listbox(root, bg='#F0F8FF', font=('Custom', 12, 'normal'), width=0, height=0)
listBoxOne.insert('0', 'hit 1 È')
listBoxOne.insert('1', 'hit 2 É')
listBoxOne.insert('2', 'hit 3 Ê')
listBoxOne.insert('3', 'draw Ë')
listBoxOne.insert('4', 'key Ì')
listBoxOne.insert('5', 'bend Í')
listBoxOne.insert('6', 'axe Î')
listBoxOne.insert('7', 'syth Ï')
listBoxOne.insert('8', 'any hit Ð')
listBoxOne.insert('9', 'any action')
listBoxOne.place(x=15, y=66)


# This is the section of code which creates the a label
Label(root, text='Solution:', bg='#F0F8FF', font=('Custom', 12, 'normal')).place(x=195, y=266)


# This is the section of code which creates a text input box
Target=Entry(root, font=('Custom', 12, 'normal'))
Target.bind('<Button-1>', SelectTextInput)
Target.place(x=150, y=176)


# This is the section of code which creates a button
Button(root, text='Solve', bg='#F0F8FF', font=('Minecraft', 15, 'bold'), command=solve).place(x=195, y=220)

listBoxOne.bind('<<ListboxSelect>>', selectedListbox)
# This is the section of code which creates the a label
Label(root, text='Target Value:', bg='#F0F8FF', font=('Minecraft', 12, 'bold')).place(x=150, y=126)

Label(root, text='Enter value needed (red arrow in anvil gui), then select one of the move restriction buttons, \nwhen it is highlighted select a move from the left. when done press solve ', bg='#F0F8FF', font=('Minecraft', 11, 'normal'),justify="left").place(x=10, y=10)

# This is the section of code which creates the a label
sol=Label(root, text='', bg='#F0F8FF', font=('Custom', 12, 'normal'),justify="left")
