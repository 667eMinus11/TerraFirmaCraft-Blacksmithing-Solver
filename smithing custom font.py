...
target = 65
hits = {"hit 1 È": -3, "hit 2 É": -6, "hit 3 Ê": -9, "draw Ë": -
        15, "key Ì": 2, "bend Í": 7, "axe Î": 13, "syth Ï": 16}
_any = ["hit 1 È", "hit 2 É", "hit 3 Ê", "draw Ë",
        "key Ì", "bend Í", "axe Î", "syth Ï"]
_hit = ["hit 1 È", "hit 2 É", "hit 3 Ê"]
# requirmentLast=_any
# requirmentSecondtoLast=_any
# requirmentThirdtoLast=_any
requirmentLast = [""]
requirmentSecondtoLast = [""]
requirmentThirdtoLast = [""]
preCombo = []
...
tree = [["hit 1 È"], ["hit 2 É"], ["hit 3 Ê"], ["draw Ë"],
        ["key Ì"], ["bend Í"], ["axe Î"], ["syth Ï"]]
_tree = tree
...
val1 = Label(root, text='any action', bg='#F0F8FF', font=(
    'Custom', 12, 'normal'), borderwidth=2, relief="groove",)
...
listBoxOne = Listbox(root, bg='#F0F8FF', font=(
    'Custom', 12, 'normal'), width=0, height=0)
...
Label(root, text='Solution:', bg='#F0F8FF', font=(
    'Custom', 12, 'normal')).place(x=195, y=266)
...
Button(root, text='Solve', bg='#F0F8FF', font=(
    'Minecraft', 15, 'bold'), command=solve).place(x=195, y=220)

listBoxOne.bind('<<ListboxSelect>>', selectedListbox)
# This is the section of code which creates the a label
Label(root, text='Target Value:', bg='#F0F8FF', font=(
    'Minecraft', 12, 'bold')).place(x=150, y=126)
...
Label(root, text='Enter value needed (red arrow in anvil gui), then select one of the move restriction buttons, \nwhen it is highlighted select a move from the left. when done press solve ',
      bg='#F0F8FF', font=('Minecraft', 11, 'normal'), justify="left").place(x=10, y=10)

# This is the section of code which creates the a label
sol = Label(root, text='', bg='#F0F8FF', font=(
    'Custom', 12, 'normal'), justify="left")
